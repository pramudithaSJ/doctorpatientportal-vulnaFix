...
<body>
	...
	<?php if (!isset($_SESSION['useremail'])) { ?>
		...
		<div style="padding:25px; border-top-left-radius:0.5em; border-top-right-radius:0.5em;"
			class="mainmenu container nav navbar-inverse" data-spy="affix" data-offset-top="100">
			<button type="button" style="background:#005173; border-color:#005173;" class="navbar-toggle"
				data-toggle="collapse" data-target="#coo">
				<span class="icon-bar"></span>
				<span class="icon-bar"></span>
				<span class="icon-bar"></span>
			</button>
			<a class="navbar-brand"><img width="85px" height="85px" style="margin-top:-38%;" title="Doctor Patient Portal"
					class="logomain" src="img/logom.png" /></a>
			<div class="collapse navbar-collapse" id="coo">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="active"><a href="help.php"><span class="glyphicon glyphicon-question-sign"></span> Help</a>
					</li>
					<?php
					if (isset($_SESSION['access_token'])) {
						echo '<li class="a"><a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span><img width="25px" height="25px" style="border-radius:50%;" src="' . $_SESSION["user_image"] . '" /></span> Hi ' . $_SESSION['user_first_name'] . ' ' . $_SESSION['user_last_name'] . ' <span class="caret"></span></a>';
						echo '<li class="a"><a  href="googlelogout.php"><span
					class="glyphicon glyphicon-user"></span> Logout</a></li>';
					} else{
						echo '<li class="a"><a data-toggle="modal" data-target="#login" href="#"><span
						class="glyphicon glyphicon-user"></span> Login</a></li>';
						echo '<li class="ar"><a data-toggle="modal" data-target="#register" href="#"><span
		...
		<div style="padding:25px; border-top-left-radius:0.5em; border-top-right-radius:0.5em;"
			...
			<div id="co" class="collapse navbar-collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<?php if ($type == "doc") { ?>
						<li class="a"><a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span
									class="glyphicon glyphicon-user"></span> Hi
								<?php echo $user ?>
								<span class="caret"></span>
							</a>
							<ul class="dropdown-menu">
								<li><a data-toggle="modal" data-target="#profiletab" href="#"><span
											class="glyphicon glyphicon-pencil"></span> Your Profile</a></li>
								<li role="separator" class="divider"></li>
								<li><a href="doctor.php"><span class="glyphicon glyphicon-th-list"></span> Your Dashboard</a>
								</li>
								<li role="separator" class="divider"></li>
					...
					<?php if ($type == "pat") { ?>
						<li class="a"><a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span
							...
							<ul class="dropdown-menu">
								<li><a data-toggle="modal" data-target="#profiletab2"><span
											class="glyphicon glyphicon-pencil"></span> Your Profile</a></li>
								<li role="separator" class="divider"></li>
								<li><a href="patient.php"><span class="glyphicon glyphicon-th-list"></span> Your Dashboard</a>
								</li>
								<li role="separator" class="divider"></li>
								<li><a href="logout.php"><span class="glyphicon glyphicon-off"></span> Logout</a></li>
							</ul>
					...
					<?php if ($type == "admin") { ?>
						<li class="a"><a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span
							...
							<ul class="dropdown-menu">
								<li><a href="adminpanel.php"><span class="glyphicon glyphicon-th-list"></span> Your
										Dashboard</a></li>
								<li role="separator" class="divider"></li>
								<li><a href="logout.php"><span class="glyphicon glyphicon-off"></span> Logout</a></li>
							</ul>
	...
	<div class="ankit container">
		...
		<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			<div class="panel panel-primary">
				...
				<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						Just Click on that green <span
							style="background:#059216; border-radius: 2em;color:white; padding:15px;">Register</span>
						button and simply Register on our site.
					</div>
				</div>
			</div>
			<br>
			<div class="panel panel-primary">
				<div class="panel-heading" role="tab" id="headingTwo">
					<h4 class="panel-title">
						<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
							...
							<span class="glyphicon glyphicon-question-sign"></span> How many days does it take to verify
							doctor account?
						</a>
					</h4>
				</div>
				<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
					<div class="panel-body">
						It's depend on our admin panel how many days they take to review your account but minimum days
						for account verification is 2 to 3 days.
					</div>
				</div>
			</div>
			<br>
			<div class="panel panel-primary">
				...
				<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
					<div class="panel-body">
						Go to patient dashboard and click on make appointment tab and make appointment with doctor. you
						can also make appointment by click on top of your name and in dropdown menu click on Quick
						Doctor List and make appointment.
					</div>
				</div>
			</div>
			<br>
			<div class="panel panel-primary">
				...
				<div id="collapsefour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
					<div class="panel-body">
						When you submit your appointment you're redirected to payment gateway where enter your details
						to done payment.
					</div>
				</div>
			</div>
				...
				<div class="panel-heading" role="tab" id="headingThree">
					<h4 class="panel-title">
						<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
							...
							<span class="glyphicon glyphicon-question-sign"></span> Refund Condition IF appointment is
							missed?
						</a>
					</h4>
				</div>
		...
		<div style="width:102.5%; margin-left:-1.2%;margin-top:-5%;" class="container footer">
			<center>&copy; 2017 | All Rights Reserved | Themed By <a style="color:white; cursor:pointer; target="
					_blank" href="https://www.facebook.com/ankitthegr8">@nkit</a> |
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div style="background:#005173; color:white;" class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-user"></span> Login
							Form Portal</h4>
					</div>
					<div class="modal-body">
						...
						<form action="" name="lfrom" method="POST">
							...
							<div class="modal-footer">
								<center><input type="submit" value="Login" name="btn_login" class="btn btn-success">
								</center>
							</div>
							<div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div style="background:#005173; color:white;" class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
								style="color:white;" aria-hidden="true">&times;</span></button>
						<h4 class="modal-title" id="myModalLabel2"><span class="glyphicon glyphicon-saved"
								aria-hidden="true"></span> Register to Portal</h4>
					</div>
					<div class="modal-body">

						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#patient" aria-controls="patient" role="tab"
									data-toggle="tab">
						...
						<div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane fade in active" id="patient">
								...
								<form method="POST" action="dp.php" ENCTYPE="multipart/form-data" action="" id="form1">
									<input type="text" name="pname" class="form-control" onkeyup="letters(this)"
										required placeholder="Enter your name"><br>
									<input type="email" name="pemail" class="form-control" required
										placeholder="Enter your email"><br>
									<input type="number" name="p_age" class="form-control" required
										placeholder="Enter your age"><br>
									<input type="password" name="p_password" class="form-control" required
										placeholder="Enter your password"><br>
									<input type="text" name="adridpt" class="form-control" required
										placeholder="Enter your Aadhar ID"><br>
									...
									<div class="input-group form-group ">
										...
										<input type="number" name="p_phone" class="form-control" id="user"
											maxlength="10" placeholder="Enter your contact no." required>
									</div>
							...
							<div role="tabpanel" class="tab-pane fade" id="doctor">
								...
								<form ENCTYPE="multipart/form-data" method="POST" action="dp.php" id="form2">
									<input type="text" name="name" class="form-control" onkeyup="letters(this)" required
									...
									<input type="text" name="docid" class="form-control" required
										placeholder="Enter your Doctor ID"><br>
									<input type="text" name="adrid" class="form-control" required
										placeholder="Enter your Aadhar ID"><br>
									...
									<div class="input-group form-group ">
										<span class="input-group-addon">+91</span>
										<input type="number" name="phone" class="form-control" id="user" maxlength="10"
											placeholder="Enter your contact no." required>
									</div>
									<label data-toggle="tooltip" data-placement="right"
										title="PDF File Supported Only">Upload Your ID*</label>
			...
			<div style="width:35%; border-radius:0em;" class="modal-dialog" role="document">
				<div class="modal-content">
					<div style="background:#005173; height:35px; color:white;" class="modal-header">
						<button style="margin-top:-1.5%;" type="button" class="close" data-dismiss="modal"
							aria-label="Close"><span style="color:white;" aria-hidden="true">&times;</span></button>
						<h5 style="font-family:calibri; margin-top:-1.5%;" class="modal-title" id="myModalLabel"><b>
								<?php echo "#$id $user"; ?>
							</b></h5>
					</div>
					<div style="border-bottom-left-radius:0px;" class="modal-body">
						...
						<div class="row">
							...
							<div class="col-md-4">
								...
								<p align="center" style="font-family:calibri; margin-top:-18%;">
									<?php echo "&nbsp;&nbsp;&nbsp;<b>ID : $docpd</b>"; ?>
								</p>
							</div>
							<div class="col-md-4">
